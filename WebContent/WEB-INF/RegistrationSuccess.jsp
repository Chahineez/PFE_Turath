          ...
          <div class="col-xl-9 mx-auto">
            <!--    <div class="cta-inner text-center rounded" > -->
              <h2 class="section-heading mb-5">
                <span class="section-heading-lower" style="padding-left: 300px;">Inscription effectuée !</span>
              </h2>
			  <span class="Accueil">Vous devez attendre que l'administrateur du système valide votre compte afin de pouvoir modifier le contenu.
			  Veuillez revenir à <a href="Accueil">l'accueil</a></span>
			  <!-- Modal Content -->

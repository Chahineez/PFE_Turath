          ...
          <div class="col-xl-9 mx-auto">
            <!--    <div class="cta-inner text-center rounded" > -->
              <h2 class="section-heading mb-5">
                <span class="section-heading-lower" style="padding-left: 200px;">Se connecter</span>
              </h2>
			   ...
			   <form action="login" method="post">
				  ...
				  <div class="container">
				    ...
				    <label>
				      ...
				      <span class="password" style="padding-left: 450px;padding-top: 0px;"> <a href="#">Mot de passe oublié?</a></span>
				    </label>
				    
				  </div>
				<div class="container"><span class="Registration">Architecte et vous n'avez pas de compte? <a href="Registration">Inscrivez-vous</a></span>
				 </div>
